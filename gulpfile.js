...
gulp.task('watch', ['clean'], function(done){
  runSequence(
    ...
    function(){
      ...
      buildBrowserify({ watch: true }).on('end', function() {runSequence(['inlineTemplates'], function() {done();})});
    }
  );
});
...
gulp.task('build', ['clean'], function(done){
  runSequence(
    ...
    function(){
      ...
      }).on('end', function() {runSequence(['inlineTemplates'], function() {done();})});
    }
  );
});

gulp.task('inlineTemplates', function(done) {
  return done();
